...
ref ={'Intro':{'path_': {'Travel':['train','from','to','flight','bus','travel'],'Food':['food','hungry']},'FV':[] , 'LV' : [] },
        'Travel': {'path_':{'booking':['book','flight','train','bus'],'cancellation':['cancel']},'FV':[],'LV':[]},
                'booking':{'path_':{'flight':['flight','plane'],'train':['train','railway','tier'],'bus':['bus']},'FV':['From','To','Date'],'LV':['Name','Class','Travel Time','Start Time','End Time','options']},
                    'flight':{'path_':{},'LV':['cheapest','earliest','fastest','next'],'FV':['Flight_no','class','Passenger Details']},
                    'train':{'path_':{},'LV':['cheapest','earliest','fastest'],'FV':['Train_no','class','Tatkaal','Passenger Details']},
